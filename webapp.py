...
def get_highest_horsepower(cars):
    ...
    for d in cars:
        if d["Engine Information"]["Engine Statistics"]["Horsepower"] > length:
            highest = d["Engine Information"]["Engine Statistics"]["Horsepower"]
            highestHorsepower = d["Engine Information"]["Engine Statistics"]["Horsepower"]
    return [highestHorsepower, highest]
